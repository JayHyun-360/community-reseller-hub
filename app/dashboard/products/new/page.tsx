...
import { MOCK_CATEGORIES, MOCK_PRODUCTS, MOCK_SELLERS } from "@/lib/mock-data";
...
export default function AddProductPage() {
  ...
  const previewProduct = {
    ...
    images: formData.images.length > 0 ? formData.images : ["https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&q=80&w=800"],
    ...
    <div className="max-w-7xl mx-auto px-4 py-12 pb-24 min-h-screen">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-8">
          <div>
            <h1 className="text-3xl font-black tracking-tighter text-zinc-900 mb-2">Add New Product</h1>
            <p className="text-zinc-500 font-medium">List a new item in your shop inventory.</p>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-zinc-50 border-2 border-dashed border-zinc-200 rounded-3xl flex flex-col items-center justify-center gap-3 cursor-pointer hover:border-zinc-300 transition-all group p-12">
              ...
              <div className="text-center">
                <p className="text-sm font-medium text-zinc-600">Click to upload product images</p>
                <p className="text-xs text-zinc-400 mt-1">Supports PNG, JPG (Max 5MB)</p>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-xs font-bold text-zinc-400 uppercase tracking-widest pl-1">Product Title</label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold text-zinc-400 uppercase tracking-widest pl-1">Initial Stock</label>
                <input
                  type="number"
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="sticky top-24">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xs font-bold text-zinc-400 uppercase tracking-widest">Live Preview</h2>
            ...
            <div className="max-w-[300px] mx-auto">
              <ProductCard product={previewProduct as any} onNotifyMe={() => {}} showSeller={true} />
            </div>
