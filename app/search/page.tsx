      ...
      <div className="mt-6 md:mt-8 min-h-[40vh]">
        {loading ? (
          <div
            ...
            className={
              tab === "products"
                ? "columns-1 sm:columns-2 md:columns-3 lg:columns-4 xl:columns-5 gap-2 sm:gap-3 md:gap-4 lg:gap-6"
          ...
          >
            {Array.from({ length: 8 }).map((_, i) => (
              <div
                ...
                className={
                  tab === "products"
                    ? "break-inside-avoid mb-2 sm:mb-3 md:mb-4 lg:mb-6"
                    : ""
                }
              >
                {tab === "products" ? (
          ...
          <div
            ...
            className={
              tab === "products"
                ? "columns-1 sm:columns-2 md:columns-3 lg:columns-4 xl:columns-5 gap-2 sm:gap-3 md:gap-4 lg:gap-6 [content-visibility:auto]"
                : "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8"
            }
          >
            {tab === "products"
              ? (results as Product[]).map((p) => (
                  <div
                    ...
                    className="cursor-pointer break-inside-avoid mb-2 sm:mb-3 md:mb-4 lg:mb-6"
                  >
                    <ProductCard
                      product={p}
