...
import { Home, Search, LayoutDashboard, LogIn, Github, Compass, X } from "lucide-react";
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              onClick={onClose}
              className={`flex items-center gap-4 px-5 py-3.5 rounded-full transition-all duration-300 font-bold ${
                isActive
